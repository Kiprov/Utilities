...
isHDAdmin = true
if rankName.Text ~= [['NonAdmin']] then
sufficientrank = true
end
end
...
local function RequestCommand(msg)
local args = {
    [1] = msg
}
...
if not game:GetService("Players"):GetPlayerFromCharacter(char) then char:FindFirstChildWhichIsA("Humanoid").Health = 0 return end
if justkill == true then
...
if isHDAdmin then
print([[To be fair, you have to be smart to use a free admin system such as HD Admin.
Infact, it's the 2nd most used admin system in Roblox games.
Yet, I don't understand the meaning of using a script that ranks you higher.
They think having high rank, means they're in charge.
Well they're wrong.
Admin level whether it's higher or lower doesn't mean that ur in control or in charge.
For an average person to abuse HD Admin it takes ]]..answer..[[ IQ points to realize the op commands they have gotten or purchased.]])
elseif not isHDAdmin and isPrisonLife then
print([[To be fair, you have to be smart to get in prison in first place.
Prison feels like a place that you can't escape, basically trapped because u did something wrong.
Tho, you want freedom or find a way to escape prison.
It takes a lot of time to dodge those pesky hackers that are like flies on a web.
Yet, one day you succeed to escape the prison and join the criminal side, but what would your choice be?
Would it be to betray your own fellow inmates or help them out by stalling the police?
Tho, it takes approximately ]]..answer..[[ IQ points to escape the prison or even to think that you can hack or arrest someone.]])
end
end
local isTouchEnabled = game:GetService("UserInputService").TouchEnabled
...
warn("Initializing anti lag..")
	...
	print("User decided to not execute an anti lag script")
end
end
local deaths = {
	"Those pesky brats.. Dont let em' get you, man!",
	"Never back down, never give up.",
	"They got you, man? Don't worry.. It's time for your payback..",
	"Show em' who's the boss, who they have to fear..",
	"Show em' no mercy..",
	"They will pay for killing you..",
	"Show em' your true power, your true form, your true self!",
	"They don't deserve peace, they deserve DOOM.",
	"Make them pay for their sin, they have done to you..",
	"Think fast! They are hopeless..",
	"Chuckle up! They stand no chance against you.. my dear friend."
}
...
local localhwid = game:GetService("RbxAnalyticsService"):GetClientId()
local room = nil
local banning = false
local icing = false
...
(disclaimer: we're actually at 9658 lines, go away)
...
function wtflmao()
local url="https://github.com/Kiprov/Utilities/blob/main/seinfeldmaintheme.mp3?raw=true"
if not isfile("Seinfeld.mp3") then
writefile("Seinfeld.mp3",game:HttpGet(url))
end
	-- Objects
	...
	eggo.SoundId = "rbxassetid://4887063009"
	eggo.TimePosition = 0.5
	eggo.Volume = 1

	local relief = Instance.new("Sound", game:GetService('Players').LocalPlayer.PlayerGui)
	relief.SoundId = (getcustomasset or getsynasset)("Seinfeld.mp3")
	relief.Volume = 1.5
	...
	eggl.SoundId = "rbxassetid://818408105"
	eggl.TimePosition = 20
	spawn(function()
		while eggl and wait() do
			if eggl.TimePosition > 22.7 then
				eggl.TimePosition = 20
			end
		end
	end)
	...
	lotsound.SoundId = "rbxassetid://3020841054"
	lotsound.Volume = 1
	...
	sound.SoundId = 'rbxassetid://188565209'
	sound:Play()
	...
	lotsound.SoundId = "rbxassetid://1210852193"
	lotsound:Play()
	wait(3)
	lotsound.SoundId = "rbxassetid://131886985"
	lotsound:Play()
	...
	while true do
		task.spawn(function()
			...
			egg.SoundId = "rbxassetid://4887063009"
			egg.TimePosition = 0.5
			egg:Play()
		end)
		task.spawn(function()
...
SendNotification({
	Title = "⚠️WARNING⚠️",
	Text = "We have detected that you are on a touchscreen device. Would you like to execute a mobile keyboard script?",
	Icon = "http://www.roblox.com/asset/?id=8800428538",
	Duration = 5,
	Callback = bindFunc,
	Button1 = "Yes",
	Button2 = "No"
...
SendNotification({
	Title = "❔Notification❔",
	Text = "For better fps(since ur on a touchscreen device), we recommend u to run an anti lag script. Would you like to run the anti lag script now?",
	Icon = "http://www.roblox.com/asset/?id=8800441559",
	Duration = 5,
	Callback = bFunc,
	Button1 = "Yes",
	Button2 = "No"
...
if usables == true then
	local v = '1255292752'
	local HeartOriginal = game:GetObjects("rbxassetid://1255292752")[1]
	local kidnaproom = game:GetObjects("rbxassetid://1345003780")[1]

	task.spawn(function()
		pcall(function()
			kidnaproom.Parent = workspace
			kidnaproom:MoveTo(Vector3.new(9999,9999,9999))
		end)
		local cur = 0
		local working = false
		kidnaproom.Collision.Touched:connect(function(hit)
			if cur < 5 and hit and hit.Parent and hit.Parent:FindFirstChildOfClass('Humanoid') and hit.Parent:FindFirstChildOfClass('Humanoid').Health <= 0 and hit.Parent:FindFirstChild('YOU HAVE SACRAFICED YOUR SOUL TO SATAN') == nil then
				...
				int.Name = 'YOU HAVE SACRAFICED YOUR SOUL TO SATAN'
				pcall(function()
					kidnaproom.SoundPart.Sound1.Volume = 5
					kidnaproom.SoundPart.Sound1.Looped = false
					kidnaproom.SoundPart.Sound1:Play()
				end)
				fire(hum)
				pcall(function()
					for i,v in pairs(kidnaproom.Pentagram:GetChildren()) do
				...
				cur = cur+1
				pcall(function()
					kidnaproom.uhoh[cur].Beam.Enabled = true
				end)
				working = false
			end
		end)
		repeat wait(1) until cur >= 5
		pcall(function()
			kidnaproom.SoundPart.Sound2.Volume = 5
			kidnaproom.SoundPart.Sound2.Looped = false
			kidnaproom.SoundPart.Sound2:Play()
		end)
		for i,v in pairs(kidnaproom:GetChildren()) do
			if v.Name == "Candle" then
				pcall(function()
					for _,a in pairs(v.Flame:GetChildren()) do
						a.Enabled = false
					end
				end)
			end
		...
		pcall(function()
			kidnaproom.BigRedOof.PointLight.Enabled = true
		end)
		ruhroh = true
		task.spawn(function()
			wait(1.5)
			demonnotify("   RITUAL FULFILLED.")
			wait(2)
			demonnotify("   PRESS ALT TO ACTIVATE.", true)
			ruhroh = true
		end)
		wait(15)
		pcall(function()
			kidnaproom.BigRedOof.PointLight.Enabled = false
		end)
		for i,v in pairs(kidnaproom:GetChildren()) do
			if v.Name == "Candle" then
				pcall(function()
...
ping.Size = UDim2.new(0.75, 0, 0.05, 0)
ping.ZIndex = 3
ping.Font = Enum.Font.SourceSansLight
ping.FontSize = Enum.FontSize.Size14
ping.Text = "PING: N/A"
...
ping.Position = UDim2.new(0,0,0.05,0)
	...
	local droneOriginal = game:GetObjects("rbxassetid://1255455698")[1]
	local v = '1255455698'
	...
	local function setR6()
		...
		if plr.Character:FindFirstChildWhichIsA("Humanoid").RigType == Enum.HumanoidRigType.R15 then
			...
			morph:FindFirstChild("handle"):Destroy()
		end
	end
	...
	if not workspace.FilteringEnabled then
		...
		notify("it's filtering enabled lol it literally wont work here. Press P to equip || Created by mustardfoot and tollonis.",true)
	end
	...
	local yez = "fuck"
	function nuke()
		notify("secret unlocked || literally a "..yez.."ing nuke")
		local ohno = Instance.new("Sound", game.Players.LocalPlayer.Character.Torso)
		ohno.SoundId = "rbxassetid://690607937"
		ohno.PlaybackSpeed = 0.7
		ohno.Volume = 1
		ohno:Play()
		wait(2.5)
		...
		rapper = Instance.new("Sound", game.Workspace)
		rapper.SoundId = "rbxassetid://903641424"
		rapper.PlaybackSpeed = 0.8
		rapper.Volume = 4
		rapper:Play()
		sound:Play()
		...
		for i,v in pairs(workspace:GetDescendants()) do
			if v:IsA('BasePart') then
				...
				if v.Name ~= "Baseplate" then
					...
					local tollonis = Instance.new("Trail", v)
					tollonis.Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(200, 63, 0)), ColorSequenceKeypoint.new(1, Color3.fromRGB(100, 31, 0))})
					tollonis.LightEmission = 1
					tollonis.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0, 0), NumberSequenceKeypoint.new(1, 1)})
					tollonis.Lifetime = 9
					tollonis.FaceCamera = false
					tollonis.Texture = "rbxassetid://286293993"
					...
					tollonis.Attachment0 = at0
					tollonis.Attachment1 = at1
				end
			end
	...
	function R6ragdollJoint(character,limbname,attached,heded,spaz)
		pcall(function()
			...
			elseif (limbname == "Head" or limbname == "Torso") and character:FindFirstChildOfClass('Humanoid') and character:FindFirstChild("Head") and character:FindFirstChild("Torso") and character.Head:FindFirstChild("Neck") == nil then
				...
				if head then
					head.Touched:connect(function(v)
						if v.CanCollide and v:IsDescendantOf(character) == false and head.Velocity.magnitude > 10 then
							sound:Play()
						end
					end)
				end
				...
				if character:FindFirstChildOfClass('Humanoid') then
					...
					if character:HasTag("hit") then return end
					Kill(character)
				end
				task.spawn(function()
		...
		if rooming == false then
			if bans then
				...
				for i,v in pairs(bans) do
				    local plah = game:GetService('Players'):FindFirstChild(v)
				    if not plah then continue end
				    local bndPlrDesc = game.Players:GetHumanoidDescriptionFromUserId(plah.CharacterAppearanceId)
					local things = game.Players:CreateHumanoidModelFromDescription(bndPlrDesc, Enum.HumanoidRigType.R6)
	...
	local Lerp = function(index: Instance, property: string | number, value: any, time: number)
		local tween: Tween = game:GetService("TweenService"):Create(index, TweenInfo.new(time * math.pi, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {[property] = value})
		tween:Play()
	...
	function grow(weld,part,endsize,endpos,amntime)
		...
		particl.Parent = part
		coroutine.wrap(Lerp)(weld, "C1", endpos, amntime)
		Lerp(part, "Size", endsize, amntime)
		weld.Parent = parent
		particl.Enabled = false
	end

	function lerp(weld,start,finish,time,longatend)
		Lerp(weld, "C0", finish, time)
	end
	...
	function spawned()
		...
		local ree = 0
		while (char:FindFirstChildWhichIsA('Humanoid') == nil or char:FindFirstChild('Head') == nil or char:FindFirstChild('Torso') == nil) and ree < 10000 do ree = ree+1 wait() end
...
if not isHDAdmin then return end
if not player.CharacterAdded or not player.Character then return end
RequestCommand(prefix.Text.."ff me")
end
end
warn("Player has died.")
end)
local url="https://github.com/Kiprov/Utilities/blob/main/doomtheme.mp3?raw=true"
if not isfile("Doom.mp3") then
writefile("Doom.mp3",game:HttpGet(url))
end
local url2="https://github.com/Kiprov/Utilities/blob/main/spookymusic.mp3?raw=true"
if not isfile("Spooky.mp3") then
writefile("Spooky.mp3",game:HttpGet(url2))
end
local url3="https://github.com/Kiprov/Utilities/blob/main/christmasmusic.mp3?raw=true"
if not isfile("Christmas.mp3") then
writefile("Christmas.mp3",game:HttpGet(url3))
end
		...
		badass.Volume = 10
		badass.Looped=true
		badass.SoundId = (getcustomasset or getsynasset)("Doom.mp3")
badass.TimePosition = died and 77.4 or not died and 0
		...
		spook.Volume = 0.5
		spook.Looped=true
		spook.SoundId = (getcustomasset or getsynasset)("Spooky.mp3")
		...
		ice.Looped=true
		ice.TimePosition = 3
		ice.SoundId = (getcustomasset or getsynasset)("Christmas.mp3")
		ice.DidLoop:Connect(function()
		ice.TimePosition = 3
		end)
		...
		function dildo()
			...
			ree.Size = Vector3.new(7.5, 2048, 7.5)
			...
			OOOOO.SoundId = 'rbxassetid://1846627271'
			OOOOO.TimePosition = 7.1
			OOOOO.Volume = 2
			OOOOO:Play()
			...
			pcall(function()
				...
				if attguess == 1 then
					...
					if rand >= 95 then
						...
						sound.Name = "NANI?"
						sound.SoundId = 'rbxassetid://940599617'
		...
		function gunmode()
			...
			pcall(function()
				...
				spooksound.SoundId = "rbxassetid://9109651770"
		...
		function longrangethotdestroyer()
			...
			pcall(function()
				...
				thott.SoundId = "rbxassetid://1413058167"
				thott.Volume = 1
				thott.TimePosition = 0.3
		...
		function stabocrabo()
			...
			pcall(function()
				...
				elseif stabb == false then
					local ohno = coroutine.wrap(function()
						working = false
		...
		game:GetService("UserInputService").InputBegan:connect(function(inputObject, gameProcessedEvent)
			if gameProcessedEvent == false then
				...
				if key == Enum.KeyCode.N then
					...
					wait()
					pcall(function()
					    --if icing then ice.TimePosition = 3 end
						ice.Playing = icing
					end)
				end
			end
...
9999999999]]
		...
		local function M1Down(actionName,is,io)
		if actionName == "M1Down" and is == Enum.UserInputState.Begin then
		...
		CAS:BindAction("M1Down",M1Down,true,Enum.UserInputType.MouseButton1)
	...
	game:GetService('RunService').RenderStepped:connect(function(step)
		frames += 1
		local pinger = string.format("%0.0f", player:GetNetworkPing()*1000)
	ping.Text = 'PING: '..pinger
	end)
		...
		while wait(0.2) do
			...
			if tracking ~= nil then
				...
				if pathfinding then
					...
					local finish = part
					local pathreee = Instance.new('Folder',Camera)
					pathree = pathreee
				...
				if linetracking then
					...
					local beam = Instance.new("Part", Camera)
